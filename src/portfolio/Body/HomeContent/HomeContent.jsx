...
<div className="leftHomeContent ">
    ...
    <div className="value">
        ...
        <h1>Hi, I am <span style={{color: "#ffae0f" ,fontSize: "45px",   letterSpacing: "3px"}}>{curElem.name}
            </span></h1>
        <h4>
    ...
    <div className="profile">
     ...
     <div className="ProjectInfo">
                    <div className="projInfo completedProj">
                        <h3><span>{curElem.completedProj}</span></h3>
                        <h5>Completed Projects</h5>
                    </div>
                    <div className="projInfo satisfiedClient">
                        <h3><span>{curElem.satisfiedClient}</span></h3>
